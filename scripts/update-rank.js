...
mongoose
  .connect(`${MONGODB_URI} + "?retryWrites=true&w=majority&appName=nith"`, opts)
  .then(async () => {
    ...
    const updatePromises = results
      .toSorted(
        (a, b) =>
          b.semesters[b.semesters.length - 1].cgpi -
          a.semesters[a.semesters.length - 1].cgpi
      )
