...
export default function Navbar({ user }: { user: sessionType["user"] }) {
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <button className="flex items-center space-x-2 px-3 py-1.5 rounded-lg">
                            ...
                            <span className="text-slate-500 dark:text-slate-300 text-sm ml-2 font-semibold hidden md:inline-block">{user.firstName}</span>
                    ...
                    <DropdownMenuContent sideOffset={15}>
                        ...
                        <DropdownMenuItem asChild>
                            <Link href={"/profile"} className="w-full text-accent-foreground hover:text-slate-800">
