    ...
    return <Card  variant="glass"  className="hover:shadow-lg animate-in popup ">
        ...
        <CardContent className="flex justify-around items-stretch gap-3 text-center">
            <div>
                ...
                <p className="text-xl font-bold text-gray-900 dark:text-white"> {maxCgpi} </p>
            </div>
            <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">CGPI</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">{cgpi}</p>
            </div>
            <div>
                <p className="text-sm text-gray-500 dark:text-gray-400"> Min CGPI</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">{minCgpi}</p>
            </div>
        </CardContent>
    </Card>
    ...
    return <Card variant="glass" className="hover:shadow-lg animate-in popup ">
        ...
        <CardContent className="flex justify-around items-stretch gap-3 text-center">
            <div>
                ...
                <p className="text-xl font-bold text-gray-900 dark:text-white">{result.rank.college}</p>
            </div>
            <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Batch</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">{result.rank.batch}</p>
            </div>
            <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Branch</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">{result.rank.branch}</p>
            </div>
            <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Class</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">{result.rank.class}</p>
            </div>
        </CardContent>
    </Card>
...
export function SemCard({ semester }: {
    ...
    return <Card variant="glass" className="rounded-lg overflow-hidden">
        <CardHeader className="bg-primary/20 p-4">
                <CardTitle>
                    Semester {semester.semester}
                </CardTitle>
            <CardDescription className="font-semibold text-gray-700">{semester.sgpi}</CardDescription>
        </CardHeader>
